...
\begin{center}
    ...
    \textbf{Dimensional Analysis \& Linear Algebra}}
...
%	\hspace{1.2cm}
	...
	& 
	\\
	\textsc{Due by:}& \textbf{Mon}, October 11 
	&
	%\hfill
	&
	%	
...
You will be assigned \emph{one} of the following problems on the internal course website. You are encouraged to do all of the problems. Your videos should be under 10 minutes long. This may mean that you have to pick what aspects of the problem are relevant to share.


\section{Dimensional Analysis: Explosive Energy} 
...
This problem refers to the `histogram space' of discretized functions.
...
% \section{Astronomy from fundamental constants}
% % From Burrows and Ostriker, 
% % https://doi.org/10.1073/PNAS.1318003111

% Our department is known for the partnership between astronomers and elementary particle physicists. To good approximations, astronomers see the periodic table as \emph{hydrogen, helium, and metal}. They see particle physics as \emph{all that stuff, plus photons and dark matter}. This problem uses dimensional analysis to show how particle physicists see astronomy. See Burros \& Ostriker \textsc{pnas} \textbf{111} 2409 (2014)\footnote{\url{https://doi.org/10.1073/PNAS.1318003111}}.

% Let use choose the fundamental dimensionful parameter to be the Planck mass, $M_\text{Pl}$. All other parameters are either dimensionless or ratios of the Planck mass to smaller mass scales. Our dimensional analysis model for `fundamental astronomy' only needs five quantities:
% \begin{enumerate}
% 	\item $M_\text{Pl}$, the Planck mass.
% 	\item $\eta_p = M_\text{Pl}/m_p \sim 10^{19}$, the ratio of the Planck mass to the proton mass
% 	\item $\eta_e = M_\text{Pl}/m_e \sim 10^{2}$, the ratio of the Planck mass to the electron mass
% 	\item $\eta_\pi = M_\text{Pl}/m_\pi \sim 10^{19}$, the ratio of the Planck mass to the pion mass; pions are the effective force carriers of the nuclear force
% 	\item $\alpha \approx 1/137$, the electromagnetic fine structure constant.
% \end{enumerate}
% Note that the gravitational coupling $G$ may be expressed with respect to a gravitational fine structure constant, $\alpha_G = Gm_p/\hbar c \sim 1/\eta_p^2$. 
