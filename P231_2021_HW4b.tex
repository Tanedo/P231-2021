...
\begin{center}
    ...
    {\Large \textsc{Homework 4B:} 
    \textbf{Harmonic Oscillator in Higher Dimensions}}
...
% \subsection{The 1D Damped Harmonic Oscillator}
% % 
...
% \subsubsection{The Full Solution, Initial Conditions}
...
% \subsubsection{Exponentially falling blip [extra credit]}
% \label{problem:exp:falling:blip}
...
% Use the result from Problem~\ref{problem:exp:falling:blip}.
